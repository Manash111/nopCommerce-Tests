...
first_name_error = (By.ID, "BillingNewAddress_FirstName-error")
last_name_error = (By.ID, "BillingNewAddress_LastName-error")
email_error = (By.ID, "BillingNewAddress_Email-error")
city_error = (By.ID, "BillingNewAddress_City-error")
address_error = (By.ID, "BillingNewAddress_Address1-error")
zip_error = (By.ID, "BillingNewAddress_ZipPostalCode-error")
phone_error = (By.ID, "BillingNewAddress_PhoneNumber-error")
REQUIRED_FIELD_ERROR = (By.CSS_SELECTOR, ".field-validation-error")
